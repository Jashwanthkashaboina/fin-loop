            ...
            <div className="row mt-5 fs-6 text-muted" style={{ lineHeight: "1.8",fontSize: "1.2em" }}>
                <div className="col-6 p-5">
                    <p>
                        ...
                        We named the company FinLoop, a combination of Zero and "Rodha", 
                ...
                <div className="col-6 p-5">
                    <p>In addition, we run a number of popular open online 
                        educational and community initiatives to 
                        empower retail traders and investors.
                    </p>
                    <p>
                        <a href=''>Rainmatter</a>, our fintech fund and incubator, has invested in several fintech 
                        startups with the goal of growing the Indian capital markets.
                    </p>
                    <p>
                        And yet, we are always up to something new every day. Catch up on the latest 
                        updates on our <a href=''>blog</a> or see what the media is <a href=''>saying about us</a> or learn 
                        more about our business and product <a href=''>philosophies</a>.
                    </p>
                </div>
            </div>
        </div>
